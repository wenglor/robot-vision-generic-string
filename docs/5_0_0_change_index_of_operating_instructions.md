...
| 1.2.0   | 13.04.2026 | Added `target:pose` and `calibration:target` commands and the [Target Pose and Camera-to-Target Calibration](4_0_robot_vision_server/4_6_0_target_pose_and_camera_to_target.md) job | Software uniVision 3.7.0    |
